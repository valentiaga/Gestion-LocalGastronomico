...
public class ControladorVistaAgregaPromocionTemporal implements ActionListener{
	
	private IVistaAgregarPromocionTemporal vista = null;
	private Ventana ventana = null;
	private JPanel contentPane = null;
	
	/*public ControladorVistaAgregaPromocionTemporal(IVistaAgregarPromocionTemporal vista, Ventana ventana) {
		this.vista = vista;
