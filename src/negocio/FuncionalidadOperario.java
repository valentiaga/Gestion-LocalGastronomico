...
public class FuncionalidadOperario
{
	 ...
	 * <br>
	 * Pre: Nya != null, NyA != "", userName != null, userName != "", password !=
	 * null, password != "" <br>
	 ...
	 * @throws UserNameRepetido_Exception     Se lanza si el nuevo nombre de usuario
	 *                                        ya existe en el sistema. <br>
	 ...
	 * @throws CantHijosInvalida_Exception cuando la cantidad de hijos es negativa.
	 *                                     <br>
	 * @throws NyARepetido_Exception       Ya existe un mozo con el nombre que
	 *                                     intenta ingresar. <br>
	 */
	public void modificaMozo(Mozo mozo, Enumerados.estadoMozo estado, int cantHijos)
			throws CantHijosInvalida_Exception, NyARepetido_Exception
	{
		if (cantHijos < 0)
	 ...
	 * @throws NoExisteID_Exception     Se lanza si el ID ingresado no esta
	 *                                  relacionado a ningun producto del sistema.
	 ...
	 * @throws NoExisteMesa_Exception           Se lanza si el ID no corresponde con
	 *                                          ninguna mesa cargada en el sistema.
	 *                                          <br>
	 * @throws CantComensalesInvalida_Exception cuando la cantidad de comensales de
	 *                                          una mesa es menos que 2. <br>
	 */
	...
	/**
	 * Metodo para agregar una promocion temporal a la coleccion de promociones
	 * temporales. <br>
	 * 
	 * @param activa
	 * @param diasDePromo    determina el dia en el que es validad la promocion
	 *                       (LUNES,MARTES,MIERCOLES,JUEVES,VIERNES,SABADO,DOMINGO;).
	 *                       <br>
	 * @param nombre         de la promocion. (identificador de la promocion
	 *                       temporal)<br>
	 * @param formaDePago    puede ser EFECTIVO,TARJETA,MERCPAGO,CTADNI. <br>
	 * @param porcentajeDesc porcentaje de descuento. <br>
	 * @param esAcumulable   determina si la promocion es acumulable con otras
	 *                       promociones. <br>
	 * @param horaInicio
	 * @param horaFinal
	 * @throws PromoRepetida_Exception cuando la promocion que se desea agregar ya
	 *                                 existe en la coleccion de promociones
	 *                                 temporales. <br>
	 */
	...
	/**
	 * Metodo para eliminar una promocion temporal de la coleccion de promociones
	 * temporales. <br>
	 * Pre: nombre != null, nombre != "". <br>
	 * Post: Se elimina la promocion temporal. <br>
	 * 
	 * @param nombre de la promocion a eliminar(identificador de la promocion
	 *               temporal). <br>
	 * @throws PromoInvalida_Exception cuando la promocion que se desea eliminar no
	 *                                 existe en la coleccion de promociones
	 *                                 temporales. <br>
	 */
	 ...
	 * 
	 * @param nombre         de la promocion temporal que se quiere modificar
	 *                       (identificador de la promocion temporal). <br>
	 * @param diasDePromo    determina el dia en el que es validad la promocion
	 *                       (LUNES,MARTES,MIERCOLES,JUEVES,VIERNES,SABADO,DOMINGO;).
	 *                       <br>
	 * @param nombre         de la promocion. (identificador de la promocion
	 ...
	 * @param horaInicio
	 * @param horaFinal
	 * @throws PromoInvalida_Exception cuando la promocion a modificar no existe.
	 *                                 <br>
	 */
	 ...
	 * @param nroMesa ID de mesa. <br>
	 * @param mozo
	 * @throws NoExisteMesa_Exception     Se lanza cuando la mesa no existe en la
	 *                                    coleccion de mesas. <br>
	 * @throws EstadoIncorrecto_Exception Se lanza cuando el estado del mozo a
	 *                                    setear es distinto de ACTIVO. <br>
	 */
	 ...
	 * @param nroMesa     ID de mesa. <br>
	 * @param formaDePago puede ser EFECTIVO,TARJETA,MERCPAGO,CTADNI. <br>
	 * @throws MesaNoOcupadaException cuando la mesa == null, o el estado de la mesa
	 *                                sigue en ocupada. <br>
	 */
	 ...
	 * @throws MozoInactivo_Exception cuando no hay ningun mozo activo para asignar
	 *                                a la mesa.<br>
	 */
	public void abreComanda(Mesa mesa) throws NoExisteMesa_Exception, MesaOcupada_Exception, MozoInactivo_Exception
	{
		...
		if (mesa != null)
		{
			if (Sistema.getInstance().getMesas().get(mesa.getNroMesa()).getEstado() == Enumerados.estadoMesa.LIBRE)
			{
				...
				throw new MesaOcupada_Exception("La mesa se encuentra ocupada.");
		} else
			throw new NoExisteMesa_Exception("No existe la mesa en el local");
	}

	/*
	 * public void agregaPedidos(Comanda comanda, int cant, int idProd) { Producto
	 * producto = Sistema.getInstance().getProductos().get(idProd);
	 ...
	 * @throws StockInsuficiente_Exception cuando la cantidad de productos a agregar
	 *                                     es mayor a su stock. <br>
	 * @throws NoExisteID_Exception        cuando el idProd no corresponde a ningun
	 *                                     producto. <br>
	 */
	public void agregaPedidos(int nroMesa, int cant, int idProd)
			throws StockInsuficiente_Exception, NoExisteID_Exception
	{
	 ...
	 * Pre: password != "", password != null, 6 <= password <= 12 caracteres con al
	 * menos un digito y una mayuscula. <br>
	 * 
	 * @param password
	 */
	...
	/**
	 * Metodo que verifica que 6 <= password <= 12 caracteres con al menos un digito
	 * y una mayuscula. <br>
	 * 
	 * @param password
	 * @return
