...
public class Sistema {
	 ...
	 * this.mozos = mozos; this.productos = productos; this.operarios = operarios;
	 * this.mesas = mesas; this.map = map; this.sueldo = sueldo; }
	 */
	 ...
	 */
	public void agregaProductoPromo(int idProd, Enumerados.diasDePromo dia, boolean aplica2x1,
	...
	public void modificaProductoPromo(int idProm, boolean activa) {
