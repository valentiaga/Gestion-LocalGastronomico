...
public class VistaAgregarPromocionTemporal extends JPanel implements IVistaAgregarPromocionTemporal {
	...
	public VistaAgregarPromocionTemporal() {
		setBorder(new TitledBorder(
				...
				"Agregar Promocion Temporal", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
